...
<Layout>
<Head>
<title>مستندات ساخت برنامه Flask - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه ساخت برنامه Flask در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# ساخت برنامه Flask در لیارا
...
<Tabs 
    ...
    <>
        {/* <video
        src="https://media.liara.ir/flask/flask-desktop.mp4"
        controls="controls"
        ...
        <div className="h-2" /> */}
        <p>
            برای ساخت برنامه، کافیست تا پس از ورود به <Link className="text-[#2196f3] " href="https://console.liara.ir">پنل کاربری</Link> 
            {" "} وارد <a href="/references/team/about/" className="text-[#2196f3]">تیم مدنظرتان</a> یا حساب شخصی‌تان، شوید؛ سپس
            وارد منوی <Link className="text-[#2196f3] " href="https://console.liara.ir/apps">پلتفرم</Link> شوید؛ بر روی گزینه <Link className="text-[#2196f3] " href="https://console.liara.ir/apps/create">ایجاد برنامه</Link> کلیک کرده و پلتفرم را بر روی <b>Flask</b> تنظیم کنید.
        ...
        <img src="https://media.liara.ir/docs/create-flask-app-using-console.gif" alt="create app using console" />
        <div className="h-4" />
    </>,
    <>
    {/* <video
        src="https://media.liara.ir/flask/flask-cli.mp4"
        controls="controls"
        className="block w-full"
        width="100%"
    ></video>
    ...
    <p>
        با اجرای دستور فوق، شما باید تیم یا حساب شخصی‌تان، شناسه، نوع پلتفرم (که باید بر روی flask باشد)، شبکه خصوصی و <Link className="text-[#2196f3] " href="/paas/details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> برنامه خود را انتخاب کنید.
    </p>
    <Asciinema id="create-flask-app-using-cli" />
...
<img src="https://media.liara.ir/docs/created-flask-app.png" alt="a ready to use nodejs app"/>
<div className="h-2" />
